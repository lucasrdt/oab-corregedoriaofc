                    ...
                    <Card key={company.id} className={`group border-border/50 shadow-sm hover:shadow-xl hover:border-primary/10 transition-all rounded-2xl overflow-hidden cursor-default ${company.highlighted ? 'bg-secondary/5 border-secondary/20' : 'bg-card'}`}>
                        <CardContent className="p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                            <div className="flex items-center gap-6">
                                <div className="h-16 w-16 rounded-2xl bg-primary text-primary-foreground flex items-center justify-center font-black text-xl shadow-2xl shadow-primary/10 overflow-hidden relative group-hover:scale-105 transition-transform">
                                    {(company as any).logo ? (
                                ...
                                <div className="space-y-1">
                                    <div className="flex items-center gap-3">
                                        ...
                                        {company.highlighted && (
                                            <span className="bg-secondary text-secondary-foreground text-[9px] font-black px-3 py-1 rounded-full uppercase tracking-tighter shadow-lg shadow-secondary/20">
                                                Destaque
                                            </span>
                                        )}
                                    </div>

                            ...
                            <div className="flex h-full flex-col">
                                <div className="p-8 border-b border-slate-100 flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <span className="px-3 py-1 bg-secondary text-secondary-foreground text-[10px] font-black uppercase rounded-full tracking-tighter shadow-sm">Rascunho Automático</span>
                                    </div>
                                </div>
            ...
            <div className="flex flex-wrap gap-3 pb-4">
                <Button
                    ...
                    className={`rounded-full px-6 h-9 font-black text-[10px] uppercase tracking-widest transition-all ${
                        selectedCategory === null ? 'bg-primary text-primary-foreground shadow-lg shadow-primary/20' : 'border-primary/10 text-primary/60 hover:text-primary hover:border-primary/30'
                    }`}
                >
                    Todos
                </Button>
                {(config.content.newsCategories || []).filter(cat => cat && cat.id != null).map((cat) => (
                    <Button
                        ...
                        className={`rounded-full px-6 h-9 font-black text-[10px] uppercase tracking-widest transition-all ${
                            selectedCategory === cat.title ? 'bg-primary text-primary-foreground shadow-lg shadow-primary/20' : 'border-primary/10 text-primary/60 hover:text-primary hover:border-primary/30'
                        }`}
                    >
                        {cat.title}
                    </Button>
                                ...
                                <div className="flex-1 p-8 flex flex-col justify-between">
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            <h3 className="text-xl font-black text-primary uppercase tracking-tight leading-tight group-hover:text-secondary transition-colors cursor-pointer" onClick={() => openEditDialog(article)}>{article.title}</h3>
                                            <div 

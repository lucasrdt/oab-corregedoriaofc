            ...
            <Dialog open={!!selectedLead} onOpenChange={() => setSelectedLead(null)}>
                <DialogContent className="max-w-2xl bg-white rounded-[3rem] border-none shadow-2xl p-0 overflow-hidden">
                    <div className="p-8 border-b border-slate-100 flex items-center justify-between">
                        ...
                        <Badge
                          variant="outline"
                          className={`${selectedLead?.read ? 'bg-slate-200 text-slate-600 hover:bg-slate-300 hover:text-slate-700' : 'bg-red-500 text-white hover:bg-red-600 hover:text-white animate-pulse'} font-black text-[9px] px-4 py-1.5 rounded-full uppercase tracking-widest border-none transition-colors duration-200 cursor-default`}
                        >
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <a href={`mailto:${selectedLead.email}`} className="text-sm font-bold text-primary hover:text-secondary transition-colors underline-offset-4 underline decoration-slate-200">
                                                {selectedLead.email}
                                            </a>
                                        </div>
                                    </div>

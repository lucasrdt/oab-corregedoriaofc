            ...
            <div className="flex h-full flex-col">
                <div className="p-8 border-b border-slate-100 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        <span className="px-3 py-1 bg-secondary text-secondary-foreground text-[10px] font-black uppercase rounded-full tracking-tighter shadow-sm">Certificado Digital</span>
                    </div>
                </div>
            ...
            <Card key={item.id} className="group border-slate-100 shadow-sm hover:shadow-2xl hover:border-primary/10 transition-all rounded-[2rem] overflow-hidden bg-white cursor-default">
              ...
              <CardContent className="p-8 space-y-6">
                <div className="space-y-4">
                  <h3 className="text-lg font-black text-primary uppercase tracking-tight leading-tight group-hover:text-secondary transition-colors min-h-[3rem] line-clamp-2">{item.title}</h3>

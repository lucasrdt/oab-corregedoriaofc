...
const AdminLogin = () => {
    ...
    const logoUrl = config?.content?.logo?.imageUrl || "https://kzlcwiwwmqtwkwwxustl.supabase.co/storage/v1/object/public/site-assets/870aef8b-6f85-4b59-8729-56dfaf35b6fa/mg7v5ppxop.png";
